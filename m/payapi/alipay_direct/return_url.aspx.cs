...
namespace ETicket.Web.payapi.alipay_direct
{
            ...
            if (sPara.Count > 0)//判断是否有带返回参数
            {
                ...
                if (verifyResult)//验证成功
                {
                    ...
                    if (Request.QueryString["trade_status"] == "TRADE_FINISHED" || Request.QueryString["trade_status"] == "TRADE_SUCCESS")
                    {
                        ...
                        //如果有做过处理，不执行商户的业务程序
                        string msg = BLL.OrderSheetBLL.Instance.PayOnline(out_trade_no, ETicket.Utility.OnlinePayEnum.支付宝.ToString(), "", "", trade_no);
