<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="refund_online.aspx.cs" Inherits="ETicket.Web.refund_online" %>
        ...
        <div class="row" style="background-color: #fff;">
            ...
            <div class="span6">
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            <span style="color:red">订单使用在线支付购买，退款成功后将返回支付账户</span>
                        </td>
                    </tr>
                    <tr>
