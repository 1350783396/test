...
namespace ETicket.Web
{
    public partial class test : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //NJiaSu.Libraries.LogHelper.LogResult("99bill", "sssssss");

            /*
            int i = 0;
         
            NJiaSu.Libraries.LogHelper.Log.Debug("Debug" + i);
            NJiaSu.Libraries.LogHelper.Log.Warn("Warn" + i);
          
            NJiaSu.Libraries.LogHelper.Log.Error("Error" + i);
            NJiaSu.Libraries.LogHelper.Log.Fatal("Fatal" + i);


            NJiaSu.Libraries.LogHelper.LogSMS.Info("LogSMS" + i);
            NJiaSu.Libraries.LogHelper.Log.Info("infot" + i);
            NJiaSu.Libraries.LogHelper.LogSMS.Info("LogSMS" + i);
            NJiaSu.Libraries.LogHelper.Log.Info("infot" + i);
            */


            //ETicket.BLL.OrderSheetBLL.Instance.PayOnline("88015895", ETicket.Utility.OnlinePayEnum.支付宝.ToString(), "", "", "");

            var a = DateTime.Compare(Convert.ToDateTime("2016-07-16 23:59:59"), ETicket.Utility.SiteConfigHelper.YZYTime);
            Response.Write(a);
            Response.End();
    ...
    public class EncrptCustor
    {
        private String key;
        public EncrptCustor()
            : this("4c53cdf5867282bdb64abb6fcc49c8")
        {
        }

        public EncrptCustor(String key)
        {
            this.key = key;
        }
