               ...
               <input name="loginpwd" id="loginpwd" value="" class="hide highlight2" type="hidden" />
                            ...
                            <div class=" uinput ub ub-f1">
                                <div class="uinn fa fa-user sc-text"></div>
								 ...
								 <input  placeholder="验证码"  id="txtValidCode" name="txtValidCode"  class="ub-f1" tabindex="6" style="ime-mode:disabled" type="text" runat="server"/> <img src="chk_code.aspx" id="randImage" onClick="loadimage();">   
                ...
                <div class="ub " id="listview">
                    <ul class="ub">
                      ...
                      <li class=" ub  bc-text ub-ac lis">
                            <div class="sc-text">
                            还没有账号?   <a href="/register.aspx">立即注册</a>                            </div>
                      </li>
                    </ul>
                </div>
                <div class="ub ">
