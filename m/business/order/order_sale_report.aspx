<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_sale_report.aspx.cs" Inherits="ETicket.Web.business.order.order_sale_report" %>
    ...
    <form id="form1" runat="server">
                ...
                <div id="main">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            ...
                            <td>日期<asp:TextBox ID="txtStartTime1" runat="server" onclick="WdatePicker()" Width="90" />--<asp:TextBox ID="txtStartTime2" runat="server" onclick="WdatePicker()" Width="90" />时间<asp:TextBox ID="txtStartHM" runat="server" onclick="WdatePicker({dateFmt:' HH:mm'})" Width="50" />
                            </td>
                        </tr>
                    ...
                    <asp:Repeater ID="repList" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%# Eval("CPTel") %></td>
                                <td style="display: none">
                                    <asp:Literal ID="litProductCategory" runat="server" /></td>
        ...
        <div id="printCosntent" style="display: none;">
            ...
            <table style="width: 200mm;">
                <tr>
                    <th style="width: 15%; text-align: center;">销售人</th>
                    <th style="width: 22%; text-align: center;">线路名称</th>
                    <th style="width: 15%; text-align: center;">产品属性</th>
                    <th style="width: 5%; text-align: center;">人数</th>
                    <th style="width: 10%; text-align: center;">客人电话</th>
                    <th style="width: 10%; text-align: center;">客人姓名</th>
                ...
                <asp:Repeater ID="rptPrint" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td style="width: 15%; text-align: center;"><%# Eval("CPName") %></td>
                            <td style="width: 22%; text-align: center;"><%# Eval("ProductName") %></td>
                            <td style="width: 15%; text-align: center;"><%# GetProperties(Eval("Properties").ToString()) %></td>
                            <td style="width: 5%; text-align: center;"><%# Eval("NUM") %>人</td>
                            <td style="width: 10%; text-align: center;"><%# Eval("Phone") %></td>
                            <td style="width: 10%; text-align: center;"><%# Eval("RealName") %></td>
                            <td style="width: 15%; text-align: center;"><%# Eval("StartAddress") %></td>
                            <td style="width: 20%; text-align: center;"><%# Eval("Memo") %></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
            </table>
