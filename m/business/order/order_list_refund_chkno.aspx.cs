...
{
    public partial class order_list_refund_chkno : AdminBase
    {
        ...
        void repList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                HyperLink hyExe = e.Item.FindControl("hyExe") as HyperLink;
                ...
                string chkUrl = string.Format("/business/order/order_refund_chkno_exe.aspx?orderid={0}", order.OrderID);
                hyExe.NavigateUrl = "#";
                hyExe.Attributes.Add("onclick", PubFun.TabNav("aodc_refund_exe_" + order.OrderID, "处理-" + order.ProductName, chkUrl));
