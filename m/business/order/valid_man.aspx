<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="valid_man.aspx.cs" Inherits="ETicket.Web.business.order.valid_man" %>
    ...
    <div id="page">
        <div id="content" class="clearfix">
            <div id="main">
                <br />
                <br />
                <h4 style="color:red">注：在验票点网络不通等情况下，无法使用验票终端时，由验票员记录订单号报给管理员验票。</h4>
                <br />
                <br />
