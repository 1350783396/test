<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_detail_over_refund.aspx.cs" Inherits="ETicket.Web.business.order.order_detail_over_refund" %>
            ...
            <div id="main">
                ...
                <br />
                 <table class="formTable" style="width:800px;">
                     ...
                     <tr>
                         <td class="label" style="height:30px;vertical-align:middle;">订单金额</td>
                         <td><asp:Literal ID="litSheetPrice" runat="server"/></td>
                     </tr>
                     <tr>
                         <td class="label" style="height:30px;vertical-align:middle;">过期退款金额</td>
                         <td>
                             <asp:TextBox ID="txtRefundPrice" runat="server" Width="100" /><span style="color:red;">*默认退款80%</span>
                         </td>
                     </tr>
                     <tr>
                         ...
                         <td>
                             ...
                             <b style="color:red">注：授权码由财务人员管理（和积分充值审核相同）</b>
                         </td>
                     </tr>
                     <tr>
                         <td class="label" style="height:30px;vertical-align:middle;">操作说明</td>
                         <td>
                 ...
                 <div style="text-align:center;width:800px;margin-top:5px;">
                    <span style="color:red;">注：所有已过期退款，将以积分形式退还到用户账户。</span>
                     <br />
                      <br />
                    <asp:Button ID="btnRefresh" Text="刷新" CssClass="btn" Width="100" runat="server" OnClientClick="return sAlert('正在刷新数据。。。请稍等！');"/>
                    <asp:Button ID="btnChk" Text="提交" CssClass="btn" Width="100" runat="server"  OnClientClick="return sys_confirm('确认过期退款？提交后无法撤消');" />
                 </div>
                <br />
                <br />
                <table class="formTable" style="width:800px;">
