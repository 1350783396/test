<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_list_refund_waitchk.aspx.cs" Inherits="ETicket.Web.business.order.order_list_refund_waitchk" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:HyperLink ID="hyCheck" runat="server" CssClass="linkAction">进入审核</asp:HyperLink>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
