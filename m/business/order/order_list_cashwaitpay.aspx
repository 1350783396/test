<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_list_cashwaitpay.aspx.cs" Inherits="ETicket.Web.business.order.order_list_cashwaitpay" %>
                ...
                <table class="formTable" >
                    <tr>
                        <td align="left" colspan="4">
                            <h4 style="color:red">注：订单支付方式为现金支付的订单，财务人员确认在收到现金情况下，点击确认收款。确认收款后，系统将发送短信(电子票)到客人手机上</h4>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:HyperLink ID="hyPay" runat="server" CssClass="linkAction">进入收款</asp:HyperLink>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
