<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_list.aspx.cs" Inherits="ETicket.Web.business.order.order_list" %>
            ...
            <div id="main">
                <table class="formTable" >
                    ...
                    <tr>
                        ...
                        <td align="left">
                           <asp:TextBox ID="txtPalyDate" runat="server" onclick="WdatePicker()" Width="95"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">
                        ...
                        <td  align="left">
                            <asp:DropDownList ID="ddlProperties" runat="server" Width="200">
                            </asp:DropDownList>
                             <asp:TextBox ID="txtProperties" runat="server" Width="200"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">
                ...
                <asp:Repeater ID="repList" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
						   ...
						   <td><%# Eval("startTime") %><%# Eval("palydate") %></td>
                            <td>
                                <%# Eval("ProductName") %>
                            </td>
                            <td>
                            ...
                            <td align="left">
                                ...
                                <asp:HyperLink ID="hyOverRefund" runat="server" Visible="false" CssClass="linkAction">过期退</asp:HyperLink>
