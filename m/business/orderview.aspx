<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderview.aspx.cs" Inherits="ETicket.Web.business.orderview" %>

<!DOCTYPE HTML>
<html>
 <head>
   <title>心客网售票管理系统</title>
          ...
          var config = [{
              ...
              menu: [{
                  ...
                  items: [
                    ...
                    { id: 'order_query', text: '订单查看', href: 'orderview/order_query.aspx' },
