<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jiDiaoMain.aspx.cs" Inherits="ETicket.Web.business.jiDiaoMain" %><head>
<!DOCTYPE html>
<html lang="en">
<style type="text/css">
<!--
...
<section class="aui-flexView">
	...
	<section class="aui-scrollView">
		...
		<div class="aui-mon-list">
			...
			<%--business/jidiao/jidiao.html--%>
			<a href="/business/jidiao/index.aspx" class="aui-flex b-line">
				<div class="aui-cou-img">
	...
	<footer class="aui-footer aui-footer-fixed">
		...
		<a href="/business/jiDiaoMain.aspx" class="aui-tabBar-item aui-tabBar-item-active">
            <div class="weui-tabbar__icon me">
