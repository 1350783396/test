...
{
    public partial class order_sms_list : PartnerBase
    {
        ...
        string Where()
        {
            ...
            //自己的订单
            sb.AppendFormat(" it.OrderUserID={0}", cookiesUser.UserID);
            //状态筛选
            if (ddlSendStatus.SelectedValue != "所有状态")
            {
                sb.AppendFormat(" and it.SendStatus='{0}'", ddlSendStatus.SelectedValue);
            }
