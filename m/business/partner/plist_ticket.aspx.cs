...
{
    public partial class plist_ticket : PartnerBase
    {
        ...
        string Where()
        {
            ...
            sb.AppendFormat(" and it.CategoryID='{0}'", "ticket");
            //状态筛选
        ...
        void LoadData(int currentPage, int pageSize)
        {
            ...
            litResultList.Text = HtmlController.Instance.TickOrderHtml(pi.List);
        }
    }
}