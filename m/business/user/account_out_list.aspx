<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account_out_list.aspx.cs" Inherits="ETicket.Web.business.user.account_out_list" %>
    ...
    <div id="page">
        <div id="content" class="clearfix">
            <div id="main">
                <br />
                <br />
                 <asp:Button ID="btnAdd" Text="新增销除" Width="200" Height="40" runat="server" CausesValidation="false"
                    CssClass="btn" PostBackUrl="~/business/user/account_out_add.aspx" />
                <br />
                <br />
                    ...
                    <ItemTemplate>
                        <tr >
                            ...
                            <td align="left" class="ht5" style="width: 30%;">
                                <asp:HyperLink ID="hyDetail" runat="server">详细</asp:HyperLink>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
