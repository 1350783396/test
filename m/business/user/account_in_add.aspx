<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account_in_add.aspx.cs" Inherits="ETicket.Web.business.user.account_in_add" %>
            ...
            <div id="content" class="clearfix">
                <div id="main">
                    <table class="formTable" style="width: 900px;">
                        ...
                        <tr>
                            <td class="label"><s>*</s>充值金额:
                            </td>
                            <td>
                                <input type="text" id="txtAccount" name="txtAccount" runat="server"/> &nbsp; &nbsp;注：1积分=1元
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <input type="submit" id="btnSave" class="btn" value="保存" style="width:100px;" onclick=" sAlert('正在保存数据。。。。。。。。。请稍等！');" runat="server" />
                                &nbsp;&nbsp;
                            <asp:Button ID="btnReturn" runat="server" Text="返回" style="width:100px;"  PostBackUrl="~/business/user/account_in_list.aspx" />
                            </td>
                        </tr>
                    </table>
                </div>
