<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account_chk_exec.aspx.cs" Inherits="ETicket.Web.business.user.account_chk_exec" %>
                ...
                <div id="main">
                    <table class="formTable" style="width: 900px;">
                        ...
                        <tr>
                            ...
                            <td>
                                 <asp:Literal ID="litAccount" runat="server"></asp:Literal> &nbsp; &nbsp;注：1积分=1元
                            </td>
                        </tr>
                       <tr>
                            <td class="label" style="height:30px;vertical-align:middle;">
                    ...
                    <table class="formTable" style="width: 900px;">
                        ...
                        <tr>
                            ...
                            <td>
                               ...
                               <b style="color:red">注：积分审核授权码由财务人员管理。</b>
                            </td>
                        </tr>
                        <tr>
                            <td class="label">
