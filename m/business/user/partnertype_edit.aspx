<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="partnertype_edit.aspx.cs" Inherits="ETicket.Web.business.user.partnertype_edit" %>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDicName"
                                ErrorMessage="*请输入分销商级别名称" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
