...
{
    public partial class valid_list : AdminBase
    {
        ...
        string Where()
        {
            ...
            //自己的订单
            sb.Append(" it.UserCategory='valid'");
        ...
        void repList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string editUrl = string.Format("/business/user/valid_edit.aspx?userid={0}", user.UserID);
                hyEdit.NavigateUrl = "#";
                hyEdit.Attributes.Add("onclick", PubFun.TabNav("u_valid_edit" + user.UserID, "编辑-" + user.UserName, editUrl));
            }
        }
    }
}