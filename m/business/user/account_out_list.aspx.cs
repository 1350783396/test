...
{
    public partial class account_out_list : AdminBase
    {
        ...
        void repList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                //Literal litPartner = e.Item.FindControl("litPartner") as Literal;
                //EFEntity.User partner = BLL.UserBLL.Instance.GetEntity(p => p.UserID == flow.UserID.Value);
                //if (partner != null)
                //    litPartner.Text = partner.CPName;
