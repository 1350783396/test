<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account_in_list.aspx.cs" Inherits="ETicket.Web.business.user.account_in_list" %>
    ...
    <div id="page">
        <div id="content" class="clearfix">
            <div id="main">
                <br />
                <br />
                 <asp:Button ID="btnAdd" Text="新增充值" Width="200" Height="40" runat="server" CausesValidation="false"
                    CssClass="btn" PostBackUrl="~/business/user/account_in_add.aspx" />
                <br />
                <br />
