<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="partner_add.aspx.cs" Inherits="ETicket.Web.business.user.partner_add" %>
            ...
            <div id="content" class="clearfix">
                <div id="main">
                    <table class="formTable" style="width: 900px;">
                        ...
                        <tr>
                            <td class="label"><s>*</s>确认密码:
                            </td>
                            <td>
                                <input type="password" id="txtPassword2" name="txtPassword2" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="label">
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:CheckBox ID="chkOnline" runat="server" Text="在线支付" Checked="true" />
