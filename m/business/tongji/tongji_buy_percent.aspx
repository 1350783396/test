<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tongji_buy_percent.aspx.cs" Inherits="ETicket.Web.business.tongji.tongji_buy_percent" %>
        ...
        <div id="content" class="clearfix">
            <div id="main">
                ...
                <asp:Repeater ID="repList" runat="server">
                    <HeaderTemplate>
                        <table class="table" cellspacing="0" border="1" style="width:900px;">
                            <thead>
                                <tr>
                                    <th class="iswarp">会员级别</th>
                                    <th class="iswarp">订单数量</th>
                                    <th class="iswarp">订单比例</th>
                                    <th class="iswarp">购买产品数量</th>
                                    <th class="iswarp">产品比例</th>
                                    <th class="iswarp">购买总金额</th>
                                    <th class="iswarp">金额比例</th>
                                </tr>
                            </thead>
                    </HeaderTemplate>
                    <ItemTemplate>
