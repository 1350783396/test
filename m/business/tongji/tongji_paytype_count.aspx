<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tongji_paytype_count.aspx.cs" Inherits="ETicket.Web.business.tongji.tongji_paytype_count" %>
                ...
                <asp:Repeater ID="repList" runat="server">
                    <HeaderTemplate>
                        <table class="table estList" cellspacing="0" border="1" style="width:900px;">
                            <thead>
                                <tr>
                                    <th class="iswarp">支付方式</th>
                                    <th class="iswarp">订单数量</th>
                                    <th class="iswarp">订单总额</th>
                                </tr>
                            </thead>
                    </HeaderTemplate>
                    <ItemTemplate>
