<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Properties1_list.aspx.cs" Inherits="ETicket.Web.business.product.Properties1_list" %>
                ...
                <br />
                   ...
                   &nbsp; &nbsp;
                             <asp:Button ID="Button1" Text="新增" Width="100" runat="server" CausesValidation="false"
                                PostBackUrl="Properties1_edit.aspx" CssClass="btn" />&nbsp;&nbsp;
                <h3>
                ...
                <asp:Repeater ID="repList" runat="server">
                    ...
                    <ItemTemplate>
                        <tr class="odd">
                            ...
                            <td>
                                <a href="Properties1_edit.aspx?id=<%#Eval("ID") %>">修改</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
