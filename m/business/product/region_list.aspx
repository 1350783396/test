<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="region_list.aspx.cs" Inherits="ETicket.Web.business.product.region_list" %>
                ...
                <br />
                   ...
                   &nbsp; &nbsp;
                             <asp:Button ID="Button1" Text="新增" Width="100" runat="server" CausesValidation="false"
                                PostBackUrl="region_edit.aspx" CssClass="btn" />&nbsp;&nbsp;
                <h3>
                    ...
                    <ItemTemplate>
                        <tr class="odd">
                            <td>
                                ...
                                <asp:Label ID="lblPKID" runat="server" Visible="false" Text='<%#Eval("RegionID") %>' />
                            </td>
                            <td>
                                <%#Eval("RegionName") %>
                            </td>
                            <td>
                                <a href="region_edit.aspx?regionid=<%#Eval("RegionID") %>">修改</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
