<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Properties2_edit.aspx.cs" Inherits="ETicket.Web.business.product.Properties2_edit" %>
            ...
            <div id="main" style="position: relative">
                ...
                <table class="formTable" style="width: 900px;">
                    <tr>
                        ...
                        <td align="left">
                            <asp:Literal ID="txtProductName" runat="server"></asp:Literal><asp:HiddenField ID="ProductID" runat="server" />
