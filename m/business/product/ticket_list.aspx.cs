...
{
    public partial class ticket_list : AdminBase
    {
        ...
        void repList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string editUrl = string.Format("/business/product/ticket_add.aspx?productid={0}", product.ProductID);
                hyEdit.NavigateUrl = "#";
        ...
        string Where()
        {
            ...
            sb.Append(" it.CategoryID =='ticket'");
            //状态筛选
