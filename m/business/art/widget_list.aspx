<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="widget_list.aspx.cs" Inherits="ETicket.Web.business.art.widget_list" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function add()
        {
            window.location.href = "widget_add.aspx?mid=<%=NJiaSu.Libraries.PubFun.QueryString("mid")%>";
            return false
        }
    </script>
</head>
                    ...
                    <ItemTemplate>
                        <tr class="even">
                            <td>
                                ...
                                <asp:Label ID="lblPKID" runat="server" Visible="false" Text='<%# Eval("PKID") %>' />
                            </td>
                            <td>
                                 <%# Eval("Title") %>
                            </td>
