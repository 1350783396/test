<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="art_list.aspx.cs" Inherits="ETicket.Web.business.art.art_list" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function add()
        {
            window.location.href = "art_add.aspx?mid="+<%=NJiaSu.Libraries.PubFun.QueryInt("mid")%>;
            return false
        }
    </script>
</head>
                    ...
                    <ItemTemplate>
                        <tr class="even">
                            <td>
                                ...
                                <asp:Label ID="lblPKID" runat="server" Visible="false" Text='<%# Eval("ArtID") %>' />
                            </td>
                            <td>
                                 <%# Eval("ArtTitle") %>
                            </td>
