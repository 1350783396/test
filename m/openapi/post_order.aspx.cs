...
namespace ETicket.Web.openapi
{
    public partial class post_order : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int productID = PubFun.QueryInt("api_productid");//产品ID
            int buyNum = PubFun.QueryInt("api_buyNum");//购买数量
            string realName = PubFun.QueryString("api_realname");//姓名
            string phone = PubFun.QueryString("api_phone");//手机号码
            ...
            if (memo.Length > 150)
            {
                memo = memo.Substring(0, 150);
            }

            string md5 = PubFun.QueryString("md5");
            string appos = "开放接口"; //PubFun.QueryString("appos");
            ...
            */
            ...
            if (transState)
            {
                ...
                */
                ...
                jsonModel.Status = "1";
                jsonModel.Msg = updateModel.SheetID;
