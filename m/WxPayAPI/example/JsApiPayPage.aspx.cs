    ...
    public partial class JsApiPayPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    var qContent=PubFun.QueryString("zq");
                ...
                string openid = jsApiPay.openid;// Request.QueryString["openid"];
                ...
                try
                {
                    ...
                    var OrderID = Session["pay_orderID"] == null ? "0" : Session["pay_orderID"].ToString();
