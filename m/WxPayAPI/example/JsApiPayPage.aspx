...
<body>
    <form runat="server">
	    ...
	    <div align="center">
            <br/><br/><br/>
            <input type="button" value="测试" onclick="callpay()" style="width:210px; height:50px; border-radius: 15px;background-color:#00CD00; border:0px #FE6714 solid; cursor: pointer;  color:white;  font-size:16px;" />
		    <br/><br/><br/>
