<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_detail.aspx.cs" Inherits="ETicket.Web.business.order.order_detail" %>
        ...
        <div id="content" class="clearfix">
            <div id="main">
                ...
                <br />
                 ...
                 <asp:Button ID="btnPay" Text="确认收款" CssClass="btn" Width="100" runat="server"  OnClientClick="return sys_confirm('确认已收取现金？确认后订单无法撤消');" />
                <br />
                <br />
