...
{
    public partial class order_list_refund_chkyes : AdminBase
    {
        ...
        void repList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                hyCheck.NavigateUrl = "#";
                hyCheck.Attributes.Add("onclick", PubFun.TabNav("aodc_" + order.OrderID, "退款-" + order.ProductName, detailUrl));
