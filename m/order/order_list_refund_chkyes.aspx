<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_list_refund_chkyes.aspx.cs" Inherits="ETicket.Web.business.order.order_list_refund_chkyes" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:HyperLink ID="hyCheck" runat="server" CssClass="linkAction">进入完成退款</asp:HyperLink>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
