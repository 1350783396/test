...
{
    public partial class chk_code : System.Web.UI.Page
    {
        ...
        private string GenerateCheckCode()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                {
                    char[] cc = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'Z', 'X', 'Y' };
                    int m = random.Next(1, 18);
                    code = cc[m];
                }
        ...
        private void CreateCheckCodeImage(string checkCode)
        {
            ...
            System.Drawing.Bitmap image = new System.Drawing.Bitmap((int)Math.Ceiling((checkCode.Length * 15.0)), 26);
