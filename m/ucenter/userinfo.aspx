<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userinfo.aspx.cs" Inherits="ETicket.Web.ucenter.userinfo" %>
    ...
    <div class="container">
         ...
         <form id="regform" runat="server" method="post">
            <div class="row" style="background-color: #fff;padding-bottom:10px;padding-top:10px;">
                <div class="span4" style="height:400px;">
                    <div class="downList">
                        <ul>
                            ...
                            <li><a id="userinfo" href="/ucenter/userinfo.aspx" class="downCk">资料管理</a></li>
                ...
                <div class="span16">
                    <div class="callout">
                        <span style="font-size:18px;font-weight:bold;">资料管理</span>
                    </div>
                    <br />
                    <br />
                    <table class="formTable">
                            ...
                            <tr>
                                <td colspan="2" style="text-align:left;">
                                    <asp:Button ID="btnSave" runat="server" Text="保存资料" class="btn btn-primary" style="width:300px;" />
                                </td>
                            </tr>
                        </table>
                </div>
