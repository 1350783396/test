...
namespace ConsoleApp1
{
	...
	public class Email
	{
		public static Email MailSystem163 = new Email(
		   mail =>
		   {
			   mail.Host = "smtp.qq.com";//使用163的SMTP服务器发送邮件
										  //mail.UseDefaultCredentials = true;//在winform平台使用默认值
			   mail.EnableSsl = true;
			   mail.UseDefaultCredentials = false;//在.framework或mvc下使用这个
			   mail.Port = 25;//端口号
			   mail.DeliveryMethod = SmtpDeliveryMethod.Network;
			   mail.Credentials = new System.Net.NetworkCredential("1350783396@qq.com", "tylxtomvaegthbjg");
		   },
		   "1350783396@qq.com",
		   "1350783396@qq.com"
	   );
		...
		/// <remarks>
		/// </remarks>
		public Email(Action<SmtpClient> mailIni, string addr_From = "", string addr_to = "")
		{
